...
tmux send-keys -t $session:$window 'CUDA_VISIBLE_DEVICES=0 python3.8 train.py --config ./configs/mobilenet_v2_3d_slowfast/p6.json' C-m

window=1
tmux new-window -t $session:$window -n 'p7'
tmux send-keys -t $session:$window 'cd ~/Projects/SmokeMon/git-repo/thermo-smoking/Pipeline/2_Detection' C-m
tmux send-keys -t $session:$window 'CUDA_VISIBLE_DEVICES=1 python3.8 train.py --config ./configs/mobilenet_v2_3d_slowfast/p7.json' C-m

window=2
tmux new-window -t $session:$window -n 'p8'
tmux send-keys -t $session:$window 'cd ~/Projects/SmokeMon/git-repo/thermo-smoking/Pipeline/2_Detection' C-m
tmux send-keys -t $session:$window 'CUDA_VISIBLE_DEVICES=2 python3.8 train.py --config ./configs/mobilenet_v2_3d_slowfast/p8.json' C-m

window=3
tmux new-window -t $session:$window -n 'p9'
tmux send-keys -t $session:$window 'cd ~/Projects/SmokeMon/git-repo/thermo-smoking/Pipeline/2_Detection' C-m
tmux send-keys -t $session:$window 'CUDA_VISIBLE_DEVICES=3 python3.8 train.py --config ./configs/mobilenet_v2_3d_slowfast/p9.json' C-m

window=4
tmux new-window -t $session:$window -n 'p10'
tmux send-keys -t $session:$window 'cd ~/Projects/SmokeMon/git-repo/thermo-smoking/Pipeline/2_Detection' C-m
tmux send-keys -t $session:$window 'CUDA_VISIBLE_DEVICES=2 python3.8 train.py --config ./configs/mobilenet_v2_3d_slowfast/p10.json' C-m
